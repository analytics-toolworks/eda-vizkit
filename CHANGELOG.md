...
- Initial public release of `eda-vizkit`.
- Added reusable exploratory data analysis visualizations.
- Added numeric distribution visualization.
- Added categorical distribution visualization.
- Added numeric-to-numeric relationship visualization.
- Added numeric-by-category relationship visualization.
- Added missing-value visualization.
- Return Matplotlib `Axes` objects so callers retain
  control over rendering, composition, annotation, and export.
- Accept caller-provided `Axes` objects for visualization composition.
